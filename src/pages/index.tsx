  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Sondy - Your Gateway to Impactful Surveys. We Simplify the Process, You Make the Decisions."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1589187775328-882e91b3db4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdXJ2ZXlzfGVufDB8fHx8MTY5MjM0MDU3OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@celpax?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Celpax`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Sondy - Your Gateway to Impactful Surveys. We Simplify the Process, You Make the Decisions.`}
            </Text>
            <Box
